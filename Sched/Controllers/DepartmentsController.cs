...
namespace Sched.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(SchedContext context)
        {
            _context = context;
        }
        ...
        {
            int NextDepartmentId = _context.Departments.Any() ? _context.Departments.Max(s => s.DepartmentId) + 1 : 1;
            ViewBag.NextDepartmentId = NextDepartmentId;
            return View();
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SchedContext.Departments'  is null.");
            }
            var department = await _context.Departments.FindAsync(id);
            if (department != null)
            {
